...
{
    /// <inheritdoc />
    public partial class adding_Student_and_Instructor_table : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubjectMaterialLink = table.Column<string>(type: "nvarchar(400)", maxLength: 400, nullable: false),
                    isFirstSemester = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Subjects_AbpUsers_InstructorId",
