...
namespace Study.Courses.Migrations
{
    ...
    [Migration("20240319192515_adding_Student_and_Instructor_table")]
    partial class adding_Student_and_Instructor_table
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Study.Courses.Students.Student", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Study.Courses.Subjects.Subject", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("SubjectMaterialLink")
                        .IsRequired()
                        .HasMaxLength(400)
                        .HasColumnType("nvarchar(400)");
            ...
            modelBuilder.Entity("StudentSubject", b =>
                {
                    b.HasOne("Study.Courses.Students.Student", null)
                        .WithMany()
                        .HasForeignKey("StudentsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Study.Courses.Subjects.Subject", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Study.Courses.Subjects.Subject", b =>
                {
                    b.HasOne("Volo.Abp.Identity.IdentityUser", "Instructor")
                        .WithMany()
